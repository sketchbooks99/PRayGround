...
{
    static_assert(std::is_base_of_v<Material, T>, "The template type is not derived type of oprt::Material.");
...
{
    static_assert(std::is_base_of_v<Shape, T>, "The template type is not derived type of oprt::Shape.");
...
{
    static_assert(std::is_base_of_v<Texture, T>, "The template type is not derived type of oprt::Texture.");
    return std::make_shared<T>(args...);
}
