...
void App::setup()
{
    ...
    // 面光源1 : Plane
    {
        ...
        setupAreaEmitter(plane_prg, plane_shadow_prg, plane_light, plane_area_emitter, transform);
    }
    ...
    // 面光源2 : Sphere
    {
        ...
        setupAreaEmitter(sphere_prg, sphere_shadow_prg, sphere_light, sphere_area_emitter, transform);
    }
