 ...
 */
CALLABLE_FUNC void DC_FUNC(sample_diffuse)(SurfaceInteraction* si, const HitGroupData* data) {
    const DiffuseData* diffuse = reinterpret_cast<DiffuseData*>(data->matdata);
