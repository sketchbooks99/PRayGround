...
// ------------------------------------------------------------------
ObjMesh::ObjMesh(const fs::path& filename, bool is_smooth)
{
...
// ------------------------------------------------------------------
OptixBuildInput ObjMesh::createBuildInput() 
{
    OptixBuildInput bi;
...
// ------------------------------------------------------------------
void ObjMesh::addVertex(const float3& v)
{
    TODO_MESSAGE();
}
...
void ObjMesh::addNormal(const float3& n)
{
    TODO_MESSAGE();
}

void ObjMesh::addTexcoord(const float2& texcoord)
{
    TODO_MESSAGE();
}

// ------------------------------------------------------------------
void ObjMesh::load(const fs::path& filename, bool is_smooth)
{
...
// ------------------------------------------------------------------
std::shared_ptr<ObjMesh> createQuadMesh(
    ...
    const float k, Axis axis) 
{
    ...
    return createObjMesh(vertices, faces, normals, texcoords, false);
}

// ------------------------------------------------------------------
std::shared_ptr<ObjMesh> createObjMesh(const std::string& filename, bool is_smooth)
{
    return std::make_shared<ObjMesh>(filename, is_smooth);
}
...
{
    return std::make_shared<ObjMesh>(vertices, faces, normals, texcoords, is_smooth);
}
