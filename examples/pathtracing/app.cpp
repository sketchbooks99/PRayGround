...
void App::setup()
{
    ...
    std::vector<EmptyRecord> callable_records(7, EmptyRecord{});
    ...
    // Prepare environment 
    shared_ptr<ConstantTexture> env_texture = make_shared<ConstantTexture>(make_float3(1.0f), constant_prg_id);
    ...
    // Preparing textures
    shared_ptr<ConstantTexture> white_constant = make_shared<ConstantTexture>(make_float3(0.8f), constant_prg_id);
    shared_ptr<ConstantTexture> red_constant = make_shared<ConstantTexture>(make_float3(0.8f, 0.05f, 0.05f), constant_prg_id);
    shared_ptr<ConstantTexture> green_constant = make_shared<ConstantTexture>(make_float3(0.05f, 0.8f, 0.05f), constant_prg_id);
    shared_ptr<CheckerTexture> checker = make_shared<CheckerTexture>(make_float3(0.9f), make_float3(0.3f), 10, checker_prg_id);
    ...
    conductor_prg.recordPackHeader(&callable_records[5]);
    area_emitter_prg.recordPackHeader(&callable_records[6]);
    ...
    sbt.addCallablesRecord(callable_records[6]);
    ...
    shared_ptr<ConstantTexture> emitter_texture = make_shared<ConstantTexture>(make_float3(1.0f), constant_prg_id);
    ...
    // Stanford bunny mesh
    {
        ...
        //shared_ptr<ConstantTexture> bunny_texture = make_shared<ConstantTexture>(make_float3(1.0f), constant_prg_id);
        auto bunny_texture = make_shared <CheckerTexture>(make_float3(0.8f, 0.8f, 0.05f), make_float3(0.3f), 10, checker_prg_id);
        bunny_texture->copyToDevice();

        //bunny_material = make_shared<Dielectric>(bunny_texture, 1.5f);
        bunny_material = make_shared<Conductor>(bunny_texture);
