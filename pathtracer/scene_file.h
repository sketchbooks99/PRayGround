...
using ScenePrimitives = std::pair<std::vector<pt::TriangleMesh>, std::vector<pt::Material*>>;

ScenePrimitives scene_primitives() {
    ScenePrimitives sp;
    ...
    auto emitter = new pt::Emitter(make_float3(1.0f), 10.0f);
    ...
    sp.first.push_back( pt::TriangleMesh( floor_vertices, floor_indices, floor_normals ) );
    sp.second.push_back( white_diffuse );
    ...
    sp.first.push_back( pt::TriangleMesh( ceiling_vertices, ceiling_indices, ceiling_normals ) );
    sp.second.push_back( white_diffuse );
    ...
    sp.first.push_back( pt::TriangleMesh( back_wall_vertices, back_wall_indices, back_wall_normals ) );
    sp.second.push_back( white_diffuse );
    ...
    sp.first.push_back( pt::TriangleMesh( right_wall_vertices, right_wall_indices, right_wall_normals ) );
    sp.second.push_back( green_diffuse );
    ...
    sp.first.push_back( pt::TriangleMesh( left_wall_vertices, left_wall_indices, left_wall_normals ) );
    sp.second.push_back( red_diffuse );
...
pt::Scene my_scene() {
    ...
    // primitive_instance.add_primitive(pt::Primitive(sphere, white_diffuse, 6));
