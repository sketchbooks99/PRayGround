 ...
 */
inline const char* rg_func_str(const std::string& name) { return ("__raygen__" + name).c_str(); }
inline const char* is_func_str(const std::string& name) { return ("__intersection__" + name).c_str(); }
inline const char* ah_func_str(const std::string& name) { return ("__anyhit__" + name).c_str(); }
inline const char* ch_func_str(const std::string& name) { return ("__closesthit__" + name).c_str(); }
inline const char* ms_func_str(const std::string& name) { return ("__miss__" + name).c_str(); }
inline const char* ex_func_str(const std::string& name) { return ("__exception__" + name).c_str(); }
inline const char* dc_func_str(const std::string& name) { return ("__direct_callabel__" + name).c_str(); }
inline const char* cc_func_str(const std::string& name) { return ("__continuation_callable__" + name).c_str(); }
