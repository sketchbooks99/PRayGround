...
Currently, you can change scene parameters such as materials, geometries, textures and sensors by modifying `scene_config.h` or including the custom header file you created that describes the scene in `oprt.cpp`. 
